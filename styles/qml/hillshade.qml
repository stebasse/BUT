...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" layerType="Raster" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="4.0.1-Norrköping">
  ...
  <elevation band="1" enabled="0" mode="RepresentsElevationSurface" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{946e5d9a-35fe-4d39-8f24-4583eae26511}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{cbce26e8-4bfb-4542-a1fd-ead07141dde2}" locked="0" pass="0">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" gradient="BlackToWhite" grayBand="1" nodataColor="" opacity="0.2" type="singlebandgray">
      <rasterTransparency/>
      <minMaxOrigin>
