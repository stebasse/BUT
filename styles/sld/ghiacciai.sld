      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#00fef6</se:SvgParameter>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#abfffc</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#00a8c6</se:SvgParameter>
            </se:Fill>
